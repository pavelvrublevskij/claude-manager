...
const PRICING_UPDATED = '2026-04-07';
const PRICING_SOURCE = 'https://docs.anthropic.com/en/docs/about-claude/pricing';
...
module.exports = { MODEL_PRICING, DEFAULT_PRICING, PRICING_UPDATED, PRICING_SOURCE, calcCost, calcCostMultiModel, addTokens, emptyTokens, buildIndex, getSessionUsage, getProjectUsageMap, removeSessionFromIndex };
